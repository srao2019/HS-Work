...
for i=1:2  
    ...
    P(1,ca,i)=nopen/num_channels; %creates an array of the open probs
...
title('Effect of increasing Ca2+ i on cluster of RyR channels');
xlabel('Ca2+i Content');
ylabel('Simulated Open Probability');
pngname=sprintf('Cluster_Cai_Sim.png');
...
pngname2=sprintf('Cluster_Cai_Theo.png');
